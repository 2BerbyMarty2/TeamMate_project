...
public class TeamManager {
    ...
    public static ArrayList<ArrayList<Player>> generateTeams(ArrayList<Player> players, int teamSize, TeamFormationStrategy strategy) {
        // LOGGING: Log the strategy class name
    ...
    public static void runTeamFormationMenu(ArrayList<Player> players, Scanner sc) {
        ...
        System.out.println("6. Hybrid (Personality + Skill)");
        System.out.println("7. Unified (All Criteria - Weighted Snake Draft)"); // Added Option 7
        ...
        switch (choice) {
            ...
            case "7": strategy = new UnifiedStrategy(); break; // Added Case 7
            case "1":
        ...
        if (save.equals("yes")) {
            ...
            ActivityLogger.log("Teams saved to CSV. Total Teams: " + teams.size());
        }
    }
}